...
| --- | --- | --- | --- | --- |
| [second-brain-devkit](https://github.com/cornjacket/second-brain-devkit) | P1 | **STALE** 2026-07-28 | **Done:** #39 (embed-excluded block, CI gate 15) · brain… | 2d |
| [create-project-system](https://github.com/cornjacket/create-project-system) | P1 | **STALE** 2026-07-28 | **19 — rename `Category` → `Worktree`.** Start here; it gates… | 2d |
| [second-brain-test](https://github.com/cornjacket/second-brain-test) | P2 | **STALE** 2026-07-28 | **Prototype #39 — the embed-excluded block — HERE by hand:** a… | 2d |
| [create-ai-builder](https://github.com/cornjacket/create-ai-builder) | P2 | **STALE** 2026-07-28 | **Begin target composition… | 2d |
| [captains-log](https://github.com/cornjacket/captains-log) | P2 | **STALE** 2026-07-29 | **Top priority — survey Claude session managers:** what tools… | 1d |
| [customer-req-responder](https://github.com/cornjacket/customer-req-responder) | P3 | **STALE** 2026-05-29 | — | 3d |
